...
#ifndef __oglge__ccUTF8__
#define __oglge__ccUTF8__
...
namespace ns_oglge {
	...
	namespace StringUtils {
		...
		std::string OGLGE_DLL format(const char* format, ...) OGLGE_FORMAT_PRINTF(1, 2);
		 ...
		 *  @endcode
		 */
		OGLGE_DLL bool UTF8ToUTF16(const std::string& inUtf8, std::u16string& outUtf16);
		 ...
		 *  @see UTF8ToUTF16
		 */
		OGLGE_DLL bool UTF8ToUTF32(const std::string& inUtf8, std::u32string& outUtf32);
		 ...
		 *  @see UTF8ToUTF16
		 */
		OGLGE_DLL bool UTF16ToUTF8(const std::u16string& inUtf16, std::string& outUtf8);
		 ...
		 *  @see UTF8ToUTF16
		 */
		OGLGE_DLL bool UTF16ToUTF32(const std::u16string& inUtf16, std::u32string& outUtf32);
		 ...
		 *  @see UTF8ToUTF16
		 */
		OGLGE_DLL bool UTF32ToUTF8(const std::u32string& inUtf32, std::string& outUtf8);
		 ...
		 *  @see UTF8ToUTF16
		 */
		OGLGE_DLL bool UTF32ToUTF16(const std::u32string& inUtf32, std::u16string& outUtf16);
		...
		*/
		OGLGE_DLL std::string getStringUTFCharsJNI(JNIEnv* env, jstring srcjStr, bool* ret = nullptr);
		...
		*/
		OGLGE_DLL jstring newStringUTFJNI(JNIEnv* env, const std::string& utf8Str, bool* ret = nullptr);
#endif

		/**
		 *  @brief Trims the unicode spaces at the end of char16_t vector.
		 */
		OGLGE_DLL void trimUTF16Vector(std::vector<char16_t>& str);
		 ...
		 *
		 */
		OGLGE_DLL bool isUnicodeSpace(char16_t ch);
		 ...
		 *
		 */
		OGLGE_DLL bool isCJKUnicode(char16_t ch);
		 ...
		 */
		OGLGE_DLL long getCharacterCountInUTF8String(const std::string& utf8);
		 ...
		 */
		OGLGE_DLL unsigned int getIndexOfLastNotChar16(const std::vector<char16_t>& str, char16_t c);

		/**
		 *  @brief Gets char16_t vector from a given utf16 string.
		 */
		OGLGE_DLL std::vector<char16_t> getChar16VectorFromUTF16String(const std::u16string& utf16);
	 ...
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL int cc_wcslen(const unsigned short* str);

	/** Trims the space characters at the end of UTF8 string.
	 *  @deprecated Please use `StringUtils::trimUTF16Vector` instead.
	 */

	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL void cc_utf8_trim_ws(std::vector<unsigned short>* str);
	 ...
	 * @see http://en.wikipedia.org/wiki/Whitespace_character#Unicode
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL bool isspace_unicode(unsigned short ch);
	 ...
	 * @see http://tieba.baidu.com/p/748765987
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL bool iscjk_unicode(unsigned short ch);
	 ...
	 * @returns The length of the string in characters.
	 **/
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL long cc_utf8_strlen(const char * p, int max = -1);
	 ...
	 * @returns The index of the last character that is not \p c.
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL unsigned int cc_utf8_find_last_not_char(const std::vector<unsigned short>& str, unsigned short c);
	 ...
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL std::vector<unsigned short> cc_utf16_vec_from_utf16_str(const unsigned short* str);
	 ...
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL unsigned short* cc_utf8_to_utf16(const char* str_old, int length = -1, int* rUtf16Size = nullptr);
	 ...
	 */
	OGLGE_DEPRECATED_ATTRIBUTE OGLGE_DLL char * cc_utf16_to_utf8(const unsigned short  *str,
		int             len = -1,
...
#endif /** defined(__oglge__ccUTF8__) */

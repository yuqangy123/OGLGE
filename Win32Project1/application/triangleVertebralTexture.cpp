...
triangleVertebralTexture::triangleVertebralTexture()
{
	init();
}
...
void triangleVertebralTexture::CreateVertexBuffer()
{
	Vector3 Vertices[8];
...
void triangleVertebralTexture::CreateIndexBuffer()
{
...
void triangleVertebralTexture::init()
{
	
	m_tech = new normalTexTechnique();
	m_tech->init();
...
void triangleVertebralTexture::mouseInput(int button, int state, int x, int y)
{
	float rx= 0.0, ry = 0.0;
...
void triangleVertebralTexture::RenderSceneCB()
{
...
void triangleVertebralTexture::draw() {

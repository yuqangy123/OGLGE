...
#define FTFontManagerIns FTFontManager::InstanceEx()
class FTFontManager : public CSingleton<FTFontManager>
{
public:
	FTFontManager();
	~FTFontManager();
...
private:
	...
	private:
		...
		public:
			...
			bool append(int wide, int tall, GLubyte *rgba, float coords[]);

...
public:
     ...
     */
    static void createFromRotationMatrix(const Matrix4f& m, Quaternion* dst);
    ...
    /**
     * Calculates the quaternion product of this quaternion with the given Vector3.

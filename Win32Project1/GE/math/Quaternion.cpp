...
void Quaternion::createFromRotationMatrix(const Matrix4f& m, Quaternion* dst)
{
    m.getRotation(dst);
}
...
void Quaternion::set(const Matrix4f& m)
{
...
void Quaternion::getMatrix(Mat4* dst)
{
	if (NULL == dst)
		return;
